...
#pragma warning disable CS0414 // El campo 'RestServicePromo.serviceUri' está asignado pero su valor nunca se usa
        static string serviceUri = "https://atx.crm.dynamics.com/";
#pragma warning restore CS0414 // El campo 'RestServicePromo.serviceUri' está asignado pero su valor nunca se usa
        ...
        public async Task<List<ValueN>> GetWeatherData2Async()
        {
            try
            {
                ...
                HttpResponseMessage responses = await httpClient.GetAsync("atx_promocions?$select=atx_name,atx_descripcion,atx_urlmasinformacion,atx_urlimagen&$orderby=createdon desc&$filter=statecode eq 0");
